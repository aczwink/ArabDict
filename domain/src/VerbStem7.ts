...
import { Gender, KASRA, NUN, Numerus, Person, SUKUN, Tense, VerbStem, VerbalNoun, Voice } from "./VerbStem";

export class VerbStem7 implements VerbStem
{
                                    ...
                                    case "third":
                                        {
                                            switch(numerus)
                                            {
                                                ...
                                                case "plural":
                                                    return "TODO";
                                                case "singular":
                                                    return ALEF + KASRA + NUN + SUKUN + this.root.r1 + FATHA + this.root.r2 + FATHA + this.root.r3 + FATHA;
                                            }
                                        }
                                }
                            }
