...
import { ALEF_HAMZA, FATHA } from "./Definitions";
import { VerbRoot } from "./VerbRoot";
import { Gender, Numerus, Person, SUKUN, Tense, VerbStem, VerbalNoun, Voice } from "./VerbStem";
                                    ...
                                    case "third":
                                        {
                                            switch(numerus)
                                            {
                                                ...
                                                case "plural":
                                                    return "TODO";
                                                case "singular":
                                                    return ALEF_HAMZA + FATHA + this.root.r1 + SUKUN + this.root.r2 + FATHA + this.root.r3 + FATHA;
                                            }
                                        }
                                }
                            }
